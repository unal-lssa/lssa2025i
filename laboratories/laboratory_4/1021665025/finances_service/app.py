...
def generate_finances_report_request():
    print(f"Received request to generate finances report with")
    # This endpoint only acknowledges the request; the API Gateway will send the task to the queue
    return jsonify({'status': 'Finances report generation request received'}), 202 
