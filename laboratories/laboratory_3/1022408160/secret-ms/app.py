...
def get_meetings():
    ...
    try:
        ...
        with conn.cursor(cursor_factory=RealDictCursor) as cur:
            cur.execute('SELECT secret_meeting_id, codename, objective, scheduled_time, location_details, security_level, access_key FROM secret_meetings ORDER BY scheduled_time;')
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5001, debug=True) # debug=True for development convenience