...
def generate_database(name):
    ...
    os.makedirs(path, exist_ok=True)  # Crea el subdirectorio.
...
def generate_docker_compose(components):
    ...
    path = "skeleton/"
    os.makedirs(path, exist_ok=True)  # Crea el directorio 'skeleton' si no existe.
