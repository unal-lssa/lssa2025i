...
# Model-Driven Software Engineering (MDE) | Lab 2
...
_DSL: Domain-Specific Language._

## 2. Inclusion of load balancer component

- Added new component type load_balancer in arch.txt:
...
- The method for generating the new component type load_balancer is added and mapped within the apply_transformations function:
...
The new component is added to the model.arch and its position in the connection flow of the components is defined, remaining between the frontend and the backend:
