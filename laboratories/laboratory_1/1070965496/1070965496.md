...
7.  Los Executors pueden leer y escribir datos desde y hacia el sistema de almacenamiento (Generalmente se utiliza un sistema de arhivos y Apache Spark se utiliza en arquitecturas de datos como los Data Lakes o la evolución de estos denominada Lakehouse).
